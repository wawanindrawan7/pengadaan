...
<head>
	...
	<script>
		WebFont.load({
			...
			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"], urls: ['{!! asset("public/atlantis/assets/css/fonts.min.css") !!}']},
			active: function() {
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img">
													<img src="{!! 'public/atlantis/assets/img/jm_denis.jpg' !!}" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img">
													<img src="{!! 'public/atlantis/assets/img/chadengle.jpg' !!}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img">
													<img src="{!! 'public/atlantis/assets/img/mlane.jpg' !!}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img">
													<img src="{!! 'public/atlantis/assets/img/talha.jpg' !!}" alt="Img Profile">
												</div>
												<div class="notif-content">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								...
								<li>
									<div class="notif-center">
										...
										<a href="#">
											<div class="notif-img">
												<img src="{!! asset('public/atlantis/assets/img/profile2.jpg') !!}" alt="Img Profile">
											</div>
											<div class="notif-content">
												<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="{!! asset('public/atlantis/assets/img/profile.jpg') !!}" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
